<form class="form form-login" action="<?=base_url() . route_to('admin_panel_user_new')?>" method="post">
    ...
    <input name="email" type="text" class="form-control" placeholder="Email" value="<?php if(isset($user)) echo $user->email ?>">
